          ...
          <div className="border rounded-lg p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <button
                ...
                className="inline-flex items-center space-x-1 px-3 py-1 bg-primary text-primary-foreground text-sm font-medium rounded-lg shadow-md hover:opacity-90 transform hover:scale-105 transition-all duration-200"
              >
                  ...
                  {requestParameters.map((param, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      ...
                      <button
                        ...
                        className="px-2 py-2 bg-destructive text-destructive-foreground rounded-lg hover:opacity-90 shadow-md hover:shadow-lg transform hover:scale-105 transition-all duration-200"
